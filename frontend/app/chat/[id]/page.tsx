...
export default function ChatDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto h-full flex flex-col bg-gray-900 rounded-lg shadow">
        {/* Chat Header */}
              ...
              >
                ...
                >
                  ...
                  <p className={`text-xs mt-1 ${
                    msg.sender?.id === user.id ? 'text-indigo-100' : 'text-gray-400'
                  }`}>
        ...
        <div className="border-t border-gray-800 p-4">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-4 py-2 border border-gray-700 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
            />
            <button
              onClick={handleSend}
